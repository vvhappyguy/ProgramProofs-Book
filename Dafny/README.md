...
а.
x := 5
exists x0 :: P[x:= x0] && x == E[x := x0]
x0 + y <= 100 && x == 5
x0 <= 100 - y && x == 5
На y нет ограничений => для любого y существует x0 => true
x == 5
...
а.
WP[[var x, x <= 100]]
{{false}} - т.к. объявление переменной не может накладывать ограничение само по себе

б.
SP[[var x, x <= 100]]
x0 <= 100
{{true}}
Сильнейшее постусловие true, т.к. достижимо любое состояние

## 2.18

[ProgramProofs.drawio](./2.18.drawio)
...
SP[[S,x<100 && x < 20>]] || SP[[T,x<100 && x >= 20>]]
SP[[S, x < 20]] || SP [[T, 20 <= x < 100]]
y == 3 && x < 20 || y == 2 && 20 <= x < 100

Упрощение:
y == 3 && x < 20 && x < 100 || y == 2 && 20 <= x && x < 100
x < 100 && (y == 3 && x < 20 || y == 2 && x >= 20)
x < 100 && ((x < 20 => y == 3) || (x >= 20 => y == 2)
...
(x < 20 => x + y == 22 && y == 3) && (x >= 20 => x + y == 22 && y == 2)
(x < 20 => x + 3 == 22) && (x >= 20 => x + 2 == 22)
(x < 20 => x == 19) && (x >= 20 => x == 20)
(!(x < 20) || x == 19) || (!(x >= 20) || x == 20) (рассматриваем два случая x < 20 и x >= 20)
(x >= 20 || x == 19) || (x < 20 || x == 20)
x == 19 || x == 20
...
WP для
if x < 8 { if x == 5 {y := 10;} else {y:=2;}} else {y := 0;}
с Q = y < 10

WP = (x < 8 ==> WP[S, Q]) && ( !(x<8) => WP[T, Q])
WP = (x < 8 ==> ((x == 5 => WP[S1,Q] && !(x==5) => WP[S2, Q]))) && ( !(x<8) => WP[T, Q])
WP = (x < 8 ==> ((x == 5 => WP[S1,Q] && !(x==5) => WP[S2, Q]))) && ( x >= 8 => WP[T, Q])
WP = (x < 8 ==> ((x == 5 => WP[S1,Q] && !(x==5) => WP[S2, Q]))) && ( x >= 8 => {true} (0 < 10))
WP = (x < 8 ==> ((x == 5 => WP[S1,Q] && x != 5 => WP[S2, Q]))) && ( x >= 8 => {true})
WP = (x < 8 ==> ((x == 5 => {false} (10 < 10) && x != 5 => {true} (2 < 10)))) && ( x >= 8 => {true})
WP = (x < 8 ==> ((x == 5 => {false}) && (x == 5 || {true} ))) && ( x < 8 || {true})
WP = (x < 8 ==> ((x == 5 => {false})))
WP = x >= 8 || x != 5 || false
WP = x != 5
...
WP
if x < 10 { if x < 20 {y := 1} else {y:= 2}} else { y:= 4 }
Q: y % 2 == 0
...
WP
if x < 8 { if x < 4 {x := x + 1} else {y:= 2}} else { if x < 32 {y := 1;} else {}}
Q: y % 2 == 0

x < 8 && ( x < 4 && y % 2 == 0 || 4 <= x)
4 <= x < 8  || x < 4 && y % 2 == 0
4 <= x < 8  || ((x < 4 || 32 =< x) && y % 2 == 0)
